    ...
    children: [
          {
            id: "cf-main-3-media",
            name: "dist",
            path: "project-name/packages/webview/dist",
            type: "folder" as const,
            children: [
          { id: "cf-main-3-css", name: "gitLogWebview.css", path: "project-name/packages/webview/dist/gitLogWebview.css", type: "file" as const, status: "A" as const },
          { id: "cf-main-3-js", name: "gitLogWebview.js", path: "project-name/packages/webview/dist/gitLogWebview.js", type: "file" as const, status: "A" as const }
            ]
          },
    ...
    children: [
      {
        ...
        name: "webview",
        path: "project-name/packages/webview",
        type: "folder" as const,
        children: [
          { id: "cf-feature-1-main", name: "main.tsx", path: "project-name/packages/webview/src/main.tsx", type: "file" as const, status: "A" as const },
          { id: "cf-feature-1-store", name: "gitLogStore.ts", path: "project-name/packages/webview/src/store/gitLogStore.ts", type: "file" as const, status: "A" as const }
        ]
      }
    ]
  }
    ...
    children: [
      {
        ...
        type: "folder" as const,
        children: [
          { id: "cf-feature-2-domain", name: "gitLogProtocol.ts", path: "project-name/packages/contracts/src/gitLogProtocol.ts", type: "file" as const, status: "A" as const },
          { id: "cf-feature-2-service", name: "gitLogApplicationService.ts", path: "project-name/packages/extension/src/application/gitLogApplicationService.ts", type: "file" as const, status: "A" as const }
        ]
      }
    ]
  }
    ...
    children: [
      {
        ...
        type: "folder" as const,
        children: [
          { id: "cf-remote-1-router", name: "webviewMessageRouter.ts", path: "project-name/packages/extension/src/extension/bridge/webviewMessageRouter.ts", type: "file" as const, status: "A" as const },
          { id: "cf-remote-1-panel", name: "gitLogPanel.ts", path: "project-name/packages/extension/src/extension/panel/gitLogPanel.ts", type: "file" as const, status: "A" as const }
        ]
      }
    ]
  }
    ...
    children: [
      {
        ...
        type: "folder" as const,
        children: [
          { id: "cf-tag-1-app", name: "App.tsx", path: "project-name/packages/webview/src/app/App.tsx", type: "file" as const, status: "A" as const }
        ]
      }
    ]
  }
