...
export class GitLogPanel {
  ...
  private async initializeWebview(extensionUri: vscode.Uri): Promise<void> {
    const stylePath = vscode.Uri.joinPath(extensionUri, "media", "webview", "gitLogWebview.css");
    const scriptPath = vscode.Uri.joinPath(extensionUri, "media", "webview", "gitLogWebview.js");
  ...
  private getHtmlForWebview(webview: vscode.Webview, extensionUri: vscode.Uri): string {
    const styleUri = webview.asWebviewUri(
      vscode.Uri.joinPath(extensionUri, "media", "webview", "gitLogWebview.css")
    );
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(extensionUri, "media", "webview", "gitLogWebview.js")
    );
